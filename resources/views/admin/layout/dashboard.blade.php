                            ...
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                <div class="iq-card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-3">
                                        ...
                                        <p class="mb-0 text-primary"><span><i class="fa fa-caret-down mr-2"></i></span>35%
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                <div class="iq-card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-3">
                                        ...
                                        <p class="mb-0 text-warning"><span><i class="fa fa-caret-up mr-2"></i></span>50%
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-6 col-xl-3">
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                <div class="iq-card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-3">
                                        <h4 class=" mb-0">+1M</h4>
                                        <p class="mb-0 text-info"><span><i class="fa fa-caret-up mr-2"></i></span>80%
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-sm-6 col-lg-6 col-xl-3">
                            <div class="iq-card iq-card-block iq-card-stretch iq-card-height">
                                <div class="iq-card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-3">
                                        <h4 class=" mb-0">+2M</h4>
                                        <p class="mb-0 text-success"><span><i class="fa fa-caret-up mr-2"></i></span>80%
                                        </p>
                                    </div>
                                </div>
                            </div>
